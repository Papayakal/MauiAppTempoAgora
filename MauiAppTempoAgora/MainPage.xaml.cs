    ...
    public partial class MainPage : ContentPage
    {
        ...
        private async void  Button_Clicked_Localizacao(object sender, EventArgs e)
        {
            try
            {
                ...
                { 
                    lbl_coords.Text = "Nenhuma localizacao"; 
                }
            }
            ...
            {
                await DisplayAlert("Erro: Localizacao Desabilitada", fneEx.Message, "OK");
            }
            catch(PermissionException pEx)
            {
                await DisplayAlert("Erro: Permissao da localizacao", pEx.Message, "OK");
            }
            catch (Exception ex)
            {
        ...
        private async void GetCidade(double lat, double lon)
        {
            ...
            {
                await DisplayAlert("Erro: Obtencao do nome da cidade", ex.Message, "OK");
            }
